                        ...
                        <tbody>
                            @foreach ($data as $index => $row)
                                <tr>
                                    ...
                                    <td class="text-start">0{{ $row->notelpon }}</td>
                                    <td class="text-start">{{ $row->tanggallahir }}</td>
                                    <td class="text-start">{{ $row->religions->nama }}</td>
                                    <td>{{ $row->created_at->format('D M Y') }}</td>
                                    <td>
                                        <a href="/tampilkandata/{{ $row->id }}" class="btn btn-info">Edit</a>
                                        {{-- <a href="/delete/{{ $row->id }}" class="btn btn-danger">Delete</a> --}}
                                        <a href="#" class="btn btn-danger delete" data-nama="{{ $row->nama }}"
