                        ...
                        <div class="card-body">
                            <form action="/insertdata" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="id_religion" aria-label="Default select example">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="notelpon" class="form-control" id="exampleInputPassword1">
                                    @error('notelpon')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
